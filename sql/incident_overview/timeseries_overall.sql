...
worksite_first_appearance AS (
  -- Find the first date each worksite appears in the analysis period
...
latest_snapshot_with_creation AS (
  -- Get the LATEST status for each work type, with its worksite's first appearance date
