...
-- Outputs daily closed-case ratios per work type. The post-processor
-- pivots these into one column per work type and applies a cumulative sum.
...
work_type_values AS (
  -- Stage 1: Get latest snapshot for each work type on each date
